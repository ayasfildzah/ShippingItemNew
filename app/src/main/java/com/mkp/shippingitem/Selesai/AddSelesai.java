package com.mkp.shippingitem.Selesai;
...
public class AddSelesai extends AppCompatActivity {
    ...
    public void saveTask1(View button) {
        Intent intent = new Intent(AddSelesai.this, ShowHistory.class);
        ...
        if (mTaskNumber.length() == 0) {
            ...
            // everything is ok!
            AddSelesai.CreateTaskTask createTask = new AddSelesai.CreateTaskTask(AddSelesai.this);
