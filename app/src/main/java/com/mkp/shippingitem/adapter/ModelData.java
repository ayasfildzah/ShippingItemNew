...
public class ModelData extends BaseAdapter implements Filterable {
    Context context;
    ...
    public ModelData(Context context, ArrayList<DataModel> listoutbox) {
