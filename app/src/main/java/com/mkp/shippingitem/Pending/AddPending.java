package com.mkp.shippingitem.Pending;
...
public class AddPending extends AppCompatActivity {
    ...
    public void saveTask1(View button) {
        Intent intent = new Intent(AddPending.this, ShowHistory.class);
        ...
        if (mTaskNumber.length() == 0) {
            ...
            // everything is ok!
            AddPending.CreateTaskTask createTask = new AddPending.CreateTaskTask(AddPending.this);
